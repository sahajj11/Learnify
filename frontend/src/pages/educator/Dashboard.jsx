    ...
    <div className='space-y-5'>
      <div className='flex flex-wrap gap-5 items-center'>
        <div className='flex items-center gap-3 shadow-card border border-blue-600 p-4 w-56 rounded-md '>
          <img className='' src={assets.patients_icon} />
          <div>
        ...
        <div className='flex items-center gap-3 shadow-card border border-blue-600 p-4 w-56 rounded-md '>
          <img className='' src={assets.appointments_icon} />
          <div>
        ...
        <div className='flex items-center gap-3 shadow-card border border-blue-600 p-4 w-56 rounded-md '>
          <img className='' src={assets.earning_icon} />
          <div>
            ...
            <tbody className='text-sm text-gray-500'>
              {dashboardData.enrolledStudentsData.map((item,index)=>(
                <tr key={index} className='border-b border-gray-500/20'>
                  ...
                  <td className='md:px-4 px-2 py-3flex items-center space-x-3'>
                    <img className='w-9 h-9 rounded-full' src={item.student.imageUrl} />
