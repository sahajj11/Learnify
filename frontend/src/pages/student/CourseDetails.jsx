...
const CourseDetails = () => {
  ...
  const [isAlreadyEnrolled,setIsAlreadyEnroled]=useState(false)
    ...
    <>
      <div className="flex md:flex-row flex-row-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left ">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-course-details-heading-large text-course-details-heading-small text-gray-800 font-semibold ">
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-[w]-300px sm:min-w-[430px] ">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              <img className="w-3.5" src={assets.time_clock_icon} />
           ...
           <div className="pt-6">
            ...
            <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
              ...
              <li>Download resource and source code.</li>
