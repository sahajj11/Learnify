  ...
  return (
    ...
    <div>
        <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-500/20 rounded'>
            <img className='md:w-auto w-10 px-3' src={assets.search_icon}/>
            <input value={input} onChange={(e)=>setInput(e.target.value)} className='w-full h-full outline-none text-gray-500/80' placeholder='Search for courses'/>
